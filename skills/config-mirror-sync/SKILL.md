...
- **Markdown抜粋ミラー**（`_shared-ai/mirrors/`）: rootの`AGENTS.md` / `CLAUDE.md`と、`commands/*.md`、`prompts/*.md`、`context/**/*.md`、`rules/**/*.md`、`skills/*/SKILL.md`だけを人間が読める形でコピーする。同期定義は`_shared-ai/sync-manifest.toml`。
